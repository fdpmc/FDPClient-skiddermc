 ...
 */
package net.ccbluex.liquidbounce.launch.data.classicui
...
class GuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        mc.fontRendererObj.drawCenteredString("FDPclassic", (width / 2).toFloat(), (bHeight - 20).toFloat(), Color.WHITE.rgb, false)
