 ...
 */
package net.ccbluex.liquidbounce.launch.data.sharedui;
...
import net.ccbluex.liquidbounce.launch.data.sharedui.clickgui.style.styles.*;
import net.ccbluex.liquidbounce.launch.data.sharedui.clickgui.style.styles.light.LightClickGUI;
import net.ccbluex.liquidbounce.launch.data.sharedui.clickgui.style.styles.novoline.ClickyUI;
import net.ccbluex.liquidbounce.launch.options.shareduiLaunchOption;
...
public class ClickGUIModule extends Module {
    ...
    public void onEnable() {
        if (styleValue.get().contains("Novoline")) {
            ...
            updateStyle();
            mc.displayGuiScreen(shareduiLaunchOption.clickGui);
        }
    ...
    private void updateStyle() {
        switch (styleValue.get().toLowerCase()) {
            case "liquidbounce":
                shareduiLaunchOption.clickGui.style = new LiquidBounceStyle();
                break;
            case "null":
                shareduiLaunchOption.clickGui.style = new NullStyle();
                break;
            case "slowly":
                shareduiLaunchOption.clickGui.style = new SlowlyStyle();
                break;
            case "black":
                shareduiLaunchOption.clickGui.style = new BlackStyle();
                break;
            case "white":
                shareduiLaunchOption.clickGui.style = new WhiteStyle();
                break;
            case "astolfo":
                shareduiLaunchOption.clickGui.style = new AstolfoStyle();
                break;
        }
    }
