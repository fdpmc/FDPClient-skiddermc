 ...
 */
package net.ccbluex.liquidbounce.launch.data.sharedui.clickgui;
...
import net.ccbluex.liquidbounce.launch.data.sharedui.clickgui.elements.Element;
...
import net.ccbluex.liquidbounce.launch.data.sharedui.clickgui.style.styles.SlowlyStyle;
...
public class ClickGui extends GuiScreen {
    ...
    public void onGuiClosed() {
        LiquidBounce.fileManager.saveConfig(shareduiLaunchOption.getClickGuiConfig());
    }
