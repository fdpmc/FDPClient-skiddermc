...
class GuiLaunchOptionSelectMenu : GuiScreen() {
    override fun initGui() {
        ...
        this.buttonList.add(GuiButton(1, this.width / 2 - 50, height / 2 + 10, 100, 20, "Classic UI (broken)"))
    }

    override fun drawScreen(mouseX: Int, mouseY: Int, pTicks: Float) {
        drawDefaultBackground()

        drawCenteredString(mc.fontRendererObj, "What main menu do you want?", width / 2, height / 2 - 40, Color.WHITE.rgb)
