...
public class Layer {
    public static int draw(int FullWidth, int FullHeight, Float width, Float height, String title, String con, int opacity, int mouseX, int mouseY, boolean click) {
        ...
        if (hover)
            RenderUtils.drawRoundedCornerRect((FullWidth + width) / 2 - 60, (FullHeight + height) / 2 - 30, (FullWidth + width) / 2 - 10, (FullHeight + height) / 2 - 10, 3f, new Color(0, 0, 0, 90).getRGB());
        else {
